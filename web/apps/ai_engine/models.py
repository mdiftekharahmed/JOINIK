...
class AnalysisResult(models.Model):
    ...
    vibration_std = models.FloatField(default=0.0)
    persistence_ratio = models.FloatField(default=0.0)
    motion_samples = models.IntegerField(default=0)
    ...
    accel_max = models.FloatField(default=0.0)
    accel_mean = models.FloatField(default=0.0)
    gyro_magnitude = models.FloatField(default=0.0)
    gyro_max = models.FloatField(default=0.0)
    gyro_mean = models.FloatField(default=0.0)
    powercut = models.IntegerField(default=0)
    cctv_cut = models.IntegerField(default=0)
    weather_state = models.CharField(max_length=50, default="UNKNOWN")
    storm_flag = models.BooleanField(default=False)
    rain_intensity = models.FloatField(default=0.0)
    confidence = models.FloatField(default=1.0)
    alarm_reason = models.TextField(blank=True)
